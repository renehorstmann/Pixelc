...
/** dst = scalar */
static cvec3 cvec3_set(int8_t scalar) {
    cvec3 res;
...
/** dst = (cvec3) v */
static cvec3 cvec3_cast_from_uchar(const uint8_t *v) {
    cvec3 res;
    cvecN_cast_into(res.v, v, 3);
    return res;
}
...
/** dst = -vec */
static cvec3 cvec3_neg_v(const int8_t *vec) {
...
/** dst = a + b */
static cvec3 cvec3_add_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_add_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a + b */
static cvec3 cvec3_add(cvec3 vec_a, int8_t scalar_b) {
    cvec3 res;
    cvecN_add(res.v, vec_a.v, scalar_b, 3);
    return res;
}
/** dst = a + b */
static cvec3 cvec3_add_v(const int8_t *vec_a, int8_t scalar_b) {
...
/** dst = a - b */
static cvec3 cvec3_sub_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_sub_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a - b */
static cvec3 cvec3_sub(cvec3 vec_a, int8_t scalar_b) {
    cvec3 res;
    cvecN_sub(res.v, vec_a.v, scalar_b, 3);
    return res;
}
/** dst = a - b */
static cvec3 cvec3_sub_v(const int8_t *vec_a, int8_t scalar_b) {
...
/** dst = a * b */
static cvec3 cvec3_scale_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_scale_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a * b */
static cvec3 cvec3_scale(cvec3 vec_a, int8_t scalar_b) {
    cvec3 res;
    cvecN_scale(res.v, vec_a.v, scalar_b, 3);
    return res;
}
/** dst = a * b */
static cvec3 cvec3_scale_v(const int8_t *vec_a, int8_t scalar_b) {
...
/** dst = a / b */
static cvec3 cvec3_div_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_div_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a / b */
static cvec3 cvec3_div(cvec3 vec_a, int8_t scalar_b) {
    cvec3 res;
    cvecN_div(res.v, vec_a.v, scalar_b, 3);
    return res;
}
/** dst = a / b */
static cvec3 cvec3_div_v(const int8_t *vec_a, int8_t scalar_b) {
...
/** dst = abs(x) */
static cvec3 cvec3_abs_v(const int8_t *vec_x) {
...
/** dst = x > 0 ? 1 : (x < 0 ? -1 : 0) */
static cvec3 cvec3_sign_v(const int8_t *vec_x) {
    return cvec3_sign(CVec3(vec_x));
}


/** dst = x % y */
static cvec3 cvec3_mod(cvec3 vec_x, int8_t y) {
    cvec3 res;
    cvecN_mod(res.v, vec_x.v, y, 3);
    return res;
}
/** dst = x % y */
static cvec3 cvec3_mod_v(const int8_t *vec_x, int8_t y) {
...
/** dst = x % y */
static cvec3 cvec3_mod_vec_v(const int8_t *vec_x, const int8_t *vec_y) {
    return cvec3_mod_vec(CVec3(vec_x), CVec3(vec_y));
}


/** dst = a < b ? a : b */
static cvec3 cvec3_min(cvec3 vec_x, int8_t y) {
    cvec3 res;
    cvecN_min(res.v, vec_x.v, y, 3);
    return res;
}
/** dst = a < b ? a : b */
static cvec3 cvec3_min_v(const int8_t *vec_x, int8_t y) {
...
/** dst = a < b ? a : b */
static cvec3 cvec3_min_vec_v(const int8_t *vec_x, const int8_t *vec_y) {
    return cvec3_min_vec(CVec3(vec_x), CVec3(vec_y));
}


/** dst = a > b ? a : b */
static cvec3 cvec3_max(cvec3 vec_x, int8_t y) {
    cvec3 res;
    cvecN_max(res.v, vec_x.v, y, 3);
    return res;
}
/** dst = a > b ? a : b */
static cvec3 cvec3_max_v(const int8_t *vec_x, int8_t y) {
...
/** dst = a > b ? a : b */
static cvec3 cvec3_max_vec_v(const int8_t *vec_x, const int8_t *vec_y) {
    return cvec3_max_vec(CVec3(vec_x), CVec3(vec_y));
}


/** dst = x < min ? min : (x > max ? max : x) */
static cvec3 cvec3_clamp(cvec3 vec_x, int8_t min, int8_t max) {
    cvec3 res;
    cvecN_clamp(res.v, vec_x.v, min, max, 3);
    return res;
}
/** dst = x < min ? min : (x > max ? max : x) */
static cvec3 cvec3_clamp_v(const int8_t *vec_x, int8_t min, int8_t max) {
...
/** dst = x < min ? min : (x > max ? max : x) */
static cvec3 cvec3_clamp_vec_v(const int8_t *vec_x, const int8_t *vec_min, const int8_t *vec_max) {
...
/** dst = a * (1-t) + b * t */
static cvec3 cvec3_mix_v(const int8_t *vec_a, const int8_t *vec_b, float t) {
...
/** dst = a * (1-t) + b * t */
static cvec3 cvec3_mix_vec_v(const int8_t *vec_a, const int8_t *vec_b, const float *vec_t) {
    return cvec3_mix_vec(CVec3(vec_a), CVec3(vec_b), vec_t);
}


/** dst = x < edge ? 0 : 1 */
static cvec3 cvec3_step(cvec3 vec_x, int8_t edge) {
    cvec3 res;
    cvecN_step(res.v, vec_x.v, edge, 3);
    return res;
}
/** dst = x < edge ? 0 : 1 */
static cvec3 cvec3_step_v(const int8_t *vec_x, int8_t edge) {
...
/** dst = x < edge ? 0 : 1 */
static cvec3 cvec3_step_vec_v(const int8_t *vec_x, const int8_t *vec_edge) {
...
/** returns vec[0] + vec[1] + ... + vec[n-1] */
static int cvec3_sum_v(const int8_t *vec) {
...
/** returns a dot b */
static int cvec3_dot_v(const int8_t *vec_a, const int8_t *vec_b) {
...
/** returns ||vec||_3 */
static float cvec3_norm_v(const int8_t *vec) {
...
/** returns ||vec||_p */
static float cvec3_norm_p_v(const int8_t *vec, float p) {
...
/** returns ||vec||_1 */
static int cvec3_norm_1_v(const int8_t *vec) {
...
/** returns ||vec||_inf */
static int cvec3_norm_inf_v(const int8_t *vec) {
...
/** returns length of a vector, see cvecN_norm. Just here to match glsl */
static float cvec3_length_v(const int8_t *vec) {
...
/** returns norm(b-a) */
static float cvec3_distance_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_distance(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a < b */
static bvec3 cvec3_less_than(cvec3 vec_a, int8_t b) {
    bvec3 res;
    cvecN_less_than(res.v, vec_a.v, b, 3);
    return res;
}
/** dst = a < b */
static bvec3 cvec3_less_than_v(const int8_t *vec_a, int8_t b) {
...
/** dst = a < b */
static bvec3 cvec3_less_than_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_less_than_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a <= b */
static bvec3 cvec3_less_than_equal(cvec3 vec_a, int8_t b) {
    bvec3 res;
    cvecN_less_than_equal(res.v, vec_a.v, b, 3);
    return res;
}
/** dst = a <= b */
static bvec3 cvec3_less_than_equal_v(const int8_t *vec_a, int8_t b) {
...
/** dst = a <= b */
static bvec3 cvec3_less_than_equal_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_less_than_equal_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a > b */
static bvec3 cvec3_greater_than(cvec3 vec_a, int8_t b) {
    bvec3 res;
    cvecN_greater_than(res.v, vec_a.v, b, 3);
    return res;
}
/** dst = a > b */
static bvec3 cvec3_greater_than_v(const int8_t *vec_a, int8_t b) {
...
/** dst = a > b */
static bvec3 cvec3_greater_than_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_greater_than_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a >= b */
static bvec3 cvec3_greater_than_equal(cvec3 vec_a, int8_t b) {
    bvec3 res;
    cvecN_greater_than_equal(res.v, vec_a.v, b, 3);
    return res;
}
/** dst = a >= b */
static bvec3 cvec3_greater_than_equal_v(const int8_t *vec_a, int8_t b) {
...
/** dst = a >= b */
static bvec3 cvec3_greater_than_equal_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_greater_than_equal_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a == b */
static bvec3 cvec3_equal(cvec3 vec_a, int8_t b) {
    bvec3 res;
    cvecN_equal(res.v, vec_a.v, b, 3);
    return res;
}
/** dst = a == b */
static bvec3 cvec3_equal_v(const int8_t *vec_a, int8_t b) {
...
/** dst = a == b */
static bvec3 cvec3_equal_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
    return cvec3_equal_vec(CVec3(vec_a), CVec3(vec_b));
}


/** dst = a != b */
static bvec3 cvec3_not_equal(cvec3 vec_a, int8_t b) {
    bvec3 res;
    cvecN_not_equal(res.v, vec_a.v, b, 3);
    return res;
}
/** dst = a != b */
static bvec3 cvec3_not_equal_v(const int8_t *vec_a, int8_t b) {
...
/** dst = a != b */
static bvec3 cvec3_not_equal_vec_v(const int8_t *vec_a, const int8_t *vec_b) {
...
/** dst = a x b */
static cvec3 cvec3_cross_v(const int8_t *vec_a, const int8_t *vec_b) {
