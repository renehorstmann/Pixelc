...
/** dst = (ucmat2) v */
static ucmat2 ucmat2_cast_from_char(const char *v) {
    ucmat2 res;
    ucvecN_cast_into(res.v, v, 2*2);
    return res;
}
...
/** dst = mat[row][:] */
static ucvec2 ucmat2_get_row_v(const uchar *mat, int row) {
...
/** dst = mat[:][col] */
static ucvec2 ucmat2_get_col_v(const uchar *mat, int col) {
...
/** dst = mat; dst[row][:] = vec */
static ucmat2 ucmat2_set_row_v(const uchar *mat, const uchar *vec, int row) {
...
/** mat[row][:] = vec; dst = mat */
static ucmat2 ucmat2_set_this_row_v(uchar *mat, const uchar *vec, int row) {
...
/** dst = mat; dst[:][col] = vec */
static ucmat2 ucmat2_set_col_v(const uchar *mat, const uchar *vec, int col) {
...
/** mat[:][col] = vec; dst = mat */
static ucmat2 ucmat2_set_this_col_v(uchar *mat, const uchar *vec, int col) {
    return ucmat2_set_this_col((ucmat2*) mat, UCVec2(vec), col);
}


/** dst = mat; dst[row][:] = scalar */
static ucmat2 ucmat2_set_row_sca(ucmat2 mat, uchar scalar, int row) {
    ucmatN_set_row_sca(mat.v, scalar, row, 2);
    return mat;
}
/** dst = mat; dst[row][:] = scalar */
static ucmat2 ucmat2_set_row_sca_v(const uchar *mat, uchar scalar, int row) {
    return ucmat2_set_row_sca(UCMat2(mat), scalar, row);
}

/** mat[row][:] = scalar; dst = mat */
static ucmat2 ucmat2_set_this_row_sca(ucmat2 *mat, uchar scalar, int row) {
    ucmatN_set_row_sca(mat->v, scalar, row, 2);
    return *mat;
}
/** mat[row][:] = scalar; dst = mat */
static ucmat2 ucmat2_set_this_row_sca_v(uchar *mat, uchar scalar, int row) {
    return ucmat2_set_this_row_sca((ucmat2*) mat, scalar, row);
}


/** dst = mat; dst[:][col] = scalar */
static ucmat2 ucmat2_set_col_sca(ucmat2 mat, uchar scalar, int col) {
    ucmatN_set_col_sca(mat.v, scalar, col, 2);
    return mat;
}
/** dst = mat; dst[:][col] = scalar */
static ucmat2 ucmat2_set_col_sca_v(const uchar *mat, uchar scalar, int col) {
    return ucmat2_set_col_sca(UCMat2(mat), scalar, col);
}

/** mat[:][col] = scalar; dst = mat */
static ucmat2 ucmat2_set_this_col_sca(ucmat2 *mat, uchar scalar, int col) {
    ucmatN_set_col_sca(mat->v, scalar, col, 2);
    return *mat;
}
/** mat[:][col] = scalar; dst = mat */
static ucmat2 ucmat2_set_this_col_sca_v(uchar *mat, uchar scalar, int col) {
    return ucmat2_set_this_col_sca((ucmat2*) mat, scalar, col);
}


/** returns sum of diagonal form upper left to lower right */
static uchar ucmat2_trace(ucmat2 mat) {
    return ucmatN_trace(mat.v, 2);
}
/** returns sum of diagonal form upper left to lower right */
static uchar ucmat2_trace_v(const uchar *mat) {
...
/** dst = mat^t */
static ucmat2 ucmat2_transpose_v(const uchar *mat) {
...
/** dst = a @ b */
static ucmat2 ucmat2_mul_mat_v(const uchar *mat_a, const uchar *mat_b) {
...
/** dst = a @ b */
static ucvec2 ucmat2_mul_vec_v(const uchar *mat_a, const uchar *vec_b) {
...
static ucmat2 ucmat2_inv(ucmat2 mat) {
    ...
    ucmat2 res;
    res.m[0][0] = (uchar) (d * inv_det);
    res.m[0][1] = (uchar) (-b * inv_det);
    res.m[1][0] = (uchar) (-c * inv_det);
    res.m[1][1] = (uchar) (a * inv_det);
    return res;
}
/** dst = inverted mat */
static ucmat2 ucmat2_inv_v(const uchar *mat) {
