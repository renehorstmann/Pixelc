...
/** dst = (ucmat2) v */
static ucmat2 ucmat2_cast_from_char(const int8_t *v) {
    ucmat2 res;
    ucvecN_cast_into(res.v, v, 2*2);
    return res;
}
...
/** dst = mat[row][:] */
static ucvec2 ucmat2_get_row_v(const uint8_t *mat, int row) {
...
/** dst = mat[:][col] */
static ucvec2 ucmat2_get_col_v(const uint8_t *mat, int col) {
...
/** dst = mat; dst[row][:] = vec */
static ucmat2 ucmat2_set_row_v(const uint8_t *mat, const uint8_t *vec, int row) {
...
/** mat[row][:] = vec; dst = mat */
static ucmat2 ucmat2_set_this_row_v(uint8_t *mat, const uint8_t *vec, int row) {
...
/** dst = mat; dst[:][col] = vec */
static ucmat2 ucmat2_set_col_v(const uint8_t *mat, const uint8_t *vec, int col) {
...
/** mat[:][col] = vec; dst = mat */
static ucmat2 ucmat2_set_this_col_v(uint8_t *mat, const uint8_t *vec, int col) {
    return ucmat2_set_this_col((ucmat2*) mat, UCVec2(vec), col);
}


/** dst = mat; dst[row][:] = scalar */
static ucmat2 ucmat2_set_row_sca(ucmat2 mat, uint8_t scalar, int row) {
    ucmatN_set_row_sca(mat.v, scalar, row, 2);
    return mat;
}
/** dst = mat; dst[row][:] = scalar */
static ucmat2 ucmat2_set_row_sca_v(const uint8_t *mat, uint8_t scalar, int row) {
    return ucmat2_set_row_sca(UCMat2(mat), scalar, row);
}

/** mat[row][:] = scalar; dst = mat */
static ucmat2 ucmat2_set_this_row_sca(ucmat2 *mat, uint8_t scalar, int row) {
    ucmatN_set_row_sca(mat->v, scalar, row, 2);
    return *mat;
}
/** mat[row][:] = scalar; dst = mat */
static ucmat2 ucmat2_set_this_row_sca_v(uint8_t *mat, uint8_t scalar, int row) {
    return ucmat2_set_this_row_sca((ucmat2*) mat, scalar, row);
}


/** dst = mat; dst[:][col] = scalar */
static ucmat2 ucmat2_set_col_sca(ucmat2 mat, uint8_t scalar, int col) {
    ucmatN_set_col_sca(mat.v, scalar, col, 2);
    return mat;
}
/** dst = mat; dst[:][col] = scalar */
static ucmat2 ucmat2_set_col_sca_v(const uint8_t *mat, uint8_t scalar, int col) {
    return ucmat2_set_col_sca(UCMat2(mat), scalar, col);
}

/** mat[:][col] = scalar; dst = mat */
static ucmat2 ucmat2_set_this_col_sca(ucmat2 *mat, uint8_t scalar, int col) {
    ucmatN_set_col_sca(mat->v, scalar, col, 2);
    return *mat;
}
/** mat[:][col] = scalar; dst = mat */
static ucmat2 ucmat2_set_this_col_sca_v(uint8_t *mat, uint8_t scalar, int col) {
    return ucmat2_set_this_col_sca((ucmat2*) mat, scalar, col);
}


/** returns sum of diagonal form upper left to lower right */
static uint8_t ucmat2_trace(ucmat2 mat) {
    return ucmatN_trace(mat.v, 2);
}
/** returns sum of diagonal form upper left to lower right */
static uint8_t ucmat2_trace_v(const uint8_t *mat) {
...
/** dst = mat^t */
static ucmat2 ucmat2_transpose_v(const uint8_t *mat) {
...
/** dst = a @ b */
static ucmat2 ucmat2_mul_mat_v(const uint8_t *mat_a, const uint8_t *mat_b) {
...
/** dst = a @ b */
static ucvec2 ucmat2_mul_vec_v(const uint8_t *mat_a, const uint8_t *vec_b) {
...
/** dst = a @ b */
static ucvec2 ucvec2_mul_mat_v(const uint8_t *vec_a, const uint8_t *mat_b) {
    return ucvec2_mul_mat(UCVec2(vec_a), UCMat2(mat_b));
}


/** returns = determinant mat */
static uint8_t ucmat2_det(ucmat2 mat) {
    // from cglm/ucmat2.h/glm_ucmat2_det
    return mat.m[0][0] * mat.m[1][1] - mat.m[1][0] * mat.m[0][1];
}
/** returns = determinant mat */
static uint8_t ucmat2_det_v(const uint8_t *mat) {
...
static ucmat2 ucmat2_inv(ucmat2 mat) {
    ...
    ucmat2 res;
    res.m[0][0] = (uint8_t) (d * inv_det);
    res.m[0][1] = (uint8_t) (-b * inv_det);
    res.m[1][0] = (uint8_t) (-c * inv_det);
    res.m[1][1] = (uint8_t) (a * inv_det);
    return res;
}
/** dst = inverted mat */
static ucmat2 ucmat2_inv_v(const uint8_t *mat) {
