...
/** dst = (ucmat4) v */
static ucmat4 ucmat4_cast_from_char(const int8_t *v) {
    ucmat4 res;
    ucvecN_cast_into(res.v, v, 4*4);
    return res;
}
...
/** dst = mat[row][:] */
static ucvec4 ucmat4_get_row_v(const uint8_t *mat, int row) {
...
/** dst = mat[:][col] */
static ucvec4 ucmat4_get_col_v(const uint8_t *mat, int col) {
...
/** dst = mat; dst[row][:] = vec */
static ucmat4 ucmat4_set_row_v(const uint8_t *mat, const uint8_t *vec, int row) {
...
/** mat[row][:] = vec; dst = mat */
static ucmat4 ucmat4_set_this_row_v(uint8_t *mat, const uint8_t *vec, int row) {
...
/** dst = mat; dst[:][col] = vec */
static ucmat4 ucmat4_set_col_v(const uint8_t *mat, const uint8_t *vec, int col) {
...
/** mat[:][col] = vec; dst = mat */
static ucmat4 ucmat4_set_this_col_v(uint8_t *mat, const uint8_t *vec, int col) {
    return ucmat4_set_this_col((ucmat4*) mat, UCVec4(vec), col);
}


/** dst = mat; dst[row][:] = scalar */
static ucmat4 ucmat4_set_row_sca(ucmat4 mat, uint8_t scalar, int row) {
    ucmatN_set_row_sca(mat.v, scalar, row, 4);
    return mat;
}
/** dst = mat; dst[row][:] = scalar */
static ucmat4 ucmat4_set_row_sca_v(const uint8_t *mat, uint8_t scalar, int row) {
    return ucmat4_set_row_sca(UCMat4(mat), scalar, row);
}

/** mat[row][:] = scalar; dst = mat */
static ucmat4 ucmat4_set_this_row_sca(ucmat4 *mat, uint8_t scalar, int row) {
    ucmatN_set_row_sca(mat->v, scalar, row, 4);
    return *mat;
}
/** mat[row][:] = scalar; dst = mat */
static ucmat4 ucmat4_set_this_row_sca_v(uint8_t *mat, uint8_t scalar, int row) {
    return ucmat4_set_this_row_sca((ucmat4*) mat, scalar, row);
}


/** dst = mat; dst[:][col] = scalar */
static ucmat4 ucmat4_set_col_sca(ucmat4 mat, uint8_t scalar, int col) {
    ucmatN_set_col_sca(mat.v, scalar, col, 4);
    return mat;
}
/** dst = mat; dst[:][col] = scalar */
static ucmat4 ucmat4_set_col_sca_v(const uint8_t *mat, uint8_t scalar, int col) {
    return ucmat4_set_col_sca(UCMat4(mat), scalar, col);
}

/** mat[:][col] = scalar; dst = mat */
static ucmat4 ucmat4_set_this_col_sca(ucmat4 *mat, uint8_t scalar, int col) {
    ucmatN_set_col_sca(mat->v, scalar, col, 4);
    return *mat;
}
/** mat[:][col] = scalar; dst = mat */
static ucmat4 ucmat4_set_this_col_sca_v(uint8_t *mat, uint8_t scalar, int col) {
    return ucmat4_set_this_col_sca((ucmat4*) mat, scalar, col);
}


/** returns sum of diagonal form upper left to lower right */
static uint8_t ucmat4_trace(ucmat4 mat) {
    return ucmatN_trace(mat.v, 4);
}
/** returns sum of diagonal form upper left to lower right */
static uint8_t ucmat4_trace_v(const uint8_t *mat) {
...
/** dst = mat^t */
static ucmat4 ucmat4_transpose_v(const uint8_t *mat) {
...
/** dst = a @ b */
static ucmat4 ucmat4_mul_mat_v(const uint8_t *mat_a, const uint8_t *mat_b) {
...
/** dst = a @ b */
static ucvec4 ucmat4_mul_vec_v(const uint8_t *mat_a, const uint8_t *vec_b) {
...
/** dst = a @ b */
static ucvec4 ucvec4_mul_mat_v(const uint8_t *vec_a, const uint8_t *mat_b) {
    return ucvec4_mul_mat(UCVec4(vec_a), UCMat4(mat_b));
}


/** returns = determinant mat */
static uint8_t ucmat4_det(ucmat4 mat) {
    // from cglm/ucmat4.h/glm_ucmat4_det
    /* [square] det(A) = det(At) */
    uint8_t t[6];
    uint8_t a = mat.m[0][0], b = mat.m[0][1], c = mat.m[0][2], d = mat.m[0][3],
...
/** returns = determinant mat */
static uint8_t ucmat4_det_v(const uint8_t *mat) {
...
static ucmat4 ucmat4_inv(ucmat4 mat) {
    ...
    uint8_t t[6];
    uint8_t a = mat.m[0][0], b = mat.m[0][1], c = mat.m[0][2], d = mat.m[0][3];
    uint8_t e = mat.m[1][0], f = mat.m[1][1], g = mat.m[1][2], h = mat.m[1][3];
    uint8_t i = mat.m[2][0], j = mat.m[2][1], k = mat.m[2][2], l = mat.m[2][3];
    uint8_t m = mat.m[3][0], n = mat.m[3][1], o = mat.m[3][2], p = mat.m[3][3];
    ...
    uint8_t inv_det = 1.0f / (a * res.m[0][0] + b * res.m[1][0]
...
/** dst = inverted mat */
static ucmat4 ucmat4_inv_v(const uint8_t *mat) {
...
/** dst = mat[col:col+2, row:row+2] */
static ucmat2 ucmat4_get_block2_v(const uint8_t *mat, int row, int col) {
...
/** dst = mat; dst[col:col+2, row:row+2] = block */
static ucmat4 ucmat4_set_block2_v(const uint8_t *mat, const uint8_t *block_2, int row, int col) {
...
/** mat[col:col+2, row:row+2] = block; dst = mat */
static ucmat4 ucmat4_set_this_block2_v(uint8_t *mat, const uint8_t *block_2, int row, int col) {
...
/** dst = mat[col:col+2, row:row+2] */
static ucmat3 ucmat4_get_block3_v(const uint8_t *mat, int row, int col) {
...
/** dst = mat; dst[col:col+2, row:row+2] = block */
static ucmat4 ucmat4_set_block3_v(const uint8_t *mat, const uint8_t *block_3, int row, int col) {
...
/** mat[col:col+2, row:row+2] = block; dst = mat */
static ucmat4 ucmat4_set_this_block3_v(uint8_t *mat, const uint8_t *block_3, int row, int col) {
...
/** dst = mat[:2, :2] */
static ucmat2 ucmat4_get_upper_left2_v(const uint8_t *mat) {
...
/** dst = mat; dst[:2, :2] = block */
static ucmat4 ucmat4_set_upper_left2_v(const uint8_t *mat, const uint8_t *block_2) {
...
/** mat[:2, :2] = block; dst = mat */
static ucmat4 ucmat4_set_this_upper_left2_v(uint8_t *mat, const uint8_t *block_2) {
...
/** dst = mat[:3, :3] */
static ucmat3 ucmat4_get_upper_left3_v(const uint8_t *mat) {
...
/** dst = mat; dst[:3, :3] = block */
static ucmat4 ucmat4_set_upper_left3_v(const uint8_t *mat, const uint8_t *block_3) {
...
/** mat[:3, :3] = block; dst = mat */
static ucmat4 ucmat4_set_this_upper_left3_v(uint8_t *mat, const uint8_t *block_3) {
