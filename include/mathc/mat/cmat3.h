...
/** dst = (cmat3) v */
static cmat3 cmat3_cast_from_uint8_t(const uint8_t *v) {
    cmat3 res;
    cvecN_cast_into(res.v, v, 3*3);
    return res;
}
...
/** dst = mat[row][:] */
static cvec3 cmat3_get_row_v(const int8_t *mat, int row) {
...
/** dst = mat[:][col] */
static cvec3 cmat3_get_col_v(const int8_t *mat, int col) {
...
/** dst = mat; dst[row][:] = vec */
static cmat3 cmat3_set_row_v(const int8_t *mat, const int8_t *vec, int row) {
...
/** mat[row][:] = vec; dst = mat */
static cmat3 cmat3_set_this_row_v(int8_t *mat, const int8_t *vec, int row) {
...
/** dst = mat; dst[:][col] = vec */
static cmat3 cmat3_set_col_v(const int8_t *mat, const int8_t *vec, int col) {
...
/** mat[:][col] = vec; dst = mat */
static cmat3 cmat3_set_this_col_v(int8_t *mat, const int8_t *vec, int col) {
    return cmat3_set_this_col((cmat3*) mat, CVec3(vec), col);
}


/** dst = mat; dst[row][:] = scalar */
static cmat3 cmat3_set_row_sca(cmat3 mat, int8_t scalar, int row) {
    cmatN_set_row_sca(mat.v, scalar, row, 3);
    return mat;
}
/** dst = mat; dst[row][:] = scalar */
static cmat3 cmat3_set_row_sca_v(const int8_t *mat, int8_t scalar, int row) {
    return cmat3_set_row_sca(CMat3(mat), scalar, row);
}

/** mat[row][:] = scalar; dst = mat */
static cmat3 cmat3_set_this_row_sca(cmat3 *mat, int8_t scalar, int row) {
    cmatN_set_row_sca(mat->v, scalar, row, 3);
    return *mat;
}
/** mat[row][:] = scalar; dst = mat */
static cmat3 cmat3_set_this_row_sca_v(int8_t *mat, int8_t scalar, int row) {
    return cmat3_set_this_row_sca((cmat3*) mat, scalar, row);
}


/** dst = mat; dst[:][col] = scalar */
static cmat3 cmat3_set_col_sca(cmat3 mat, int8_t scalar, int col) {
    cmatN_set_col_sca(mat.v, scalar, col, 3);
    return mat;
}
/** dst = mat; dst[:][col] = scalar */
static cmat3 cmat3_set_col_sca_v(const int8_t *mat, int8_t scalar, int col) {
    return cmat3_set_col_sca(CMat3(mat), scalar, col);
}

/** mat[:][col] = scalar; dst = mat */
static cmat3 cmat3_set_this_col_sca(cmat3 *mat, int8_t scalar, int col) {
    cmatN_set_col_sca(mat->v, scalar, col, 3);
    return *mat;
}
/** mat[:][col] = scalar; dst = mat */
static cmat3 cmat3_set_this_col_sca_v(int8_t *mat, int8_t scalar, int col) {
...
/** returns sum of diagonal form upper left to lower right */
static int cmat3_trace_v(const int8_t *mat) {
...
/** dst = mat^t */
static cmat3 cmat3_transpose_v(const int8_t *mat) {
...
/** dst = a @ b */
static cmat3 cmat3_mul_mat_v(const int8_t *mat_a, const int8_t *mat_b) {
...
/** dst = a @ b */
static cvec3 cmat3_mul_vec_v(const int8_t *mat_a, const int8_t *vec_b) {
...
/** dst = a @ b */
static cvec3 cvec3_mul_mat_v(const int8_t *vec_a, const int8_t *mat_b) {
...
static int cmat3_det(cmat3 mat) {
    ...
    int8_t a = mat.m[0][0], b = mat.m[0][1], c = mat.m[0][2];
    int8_t d = mat.m[1][0], e = mat.m[1][1], f = mat.m[1][2];
    int8_t g = mat.m[2][0], h = mat.m[2][1], i = mat.m[2][2];

    return a * (e * i - h * f) - d * (b * i - c * h) + g * (b * f - c * e);
}
/** returns = determinant mat */
static int cmat3_det_v(const int8_t *mat) {
...
static cmat3 cmat3_inv(cmat3 mat) {
    ...
    int8_t inv_det = (int8_t) (1.0f / (a * res.m[0][0] + b * res.m[1][0] + c * res.m[2][0]));

    cvecN_scale(res.v, res.v, inv_det, 9);
    return res;
}
/** dst = inverted mat */
static cmat3 cmat3_inv_v(const int8_t *mat) {
...
/** dst = mat[col:col+2, row:row+2] */
static cmat2 cmat3_get_block2_v(const int8_t *mat, int row, int col) {
...
/** dst = mat; dst[col:col+2, row:row+2] = block */
static cmat3 cmat3_set_block2_v(const int8_t *mat, const int8_t *block_2, int row, int col) {
...
/** mat[col:col+2, row:row+2] = block; dst = mat */
static cmat3 cmat3_set_this_block2_v(int8_t *mat, const int8_t *block_2, int row, int col) {
...
/** dst = mat[:2, :2] */
static cmat2 cmat3_get_upper_left_v(const int8_t *mat) {
...
/** dst = mat; dst[:2, :2] = block */
static cmat3 cmat3_set_upper_left_v(const int8_t *mat, const int8_t *block_2) {
...
/** mat[:2, :2] = block; dst = mat */
static cmat3 cmat3_set_this_upper_left_v(int8_t *mat, const int8_t *block_2) {
