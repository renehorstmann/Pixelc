...
/** dst = mat[row][:] */
static cvec4 cmat4_get_row_v(const char *mat, int row) {
...
/** dst = mat[:][col] */
static cvec4 cmat4_get_col_v(const char *mat, int col) {
...
/** dst = mat; dst[row][:] = vec */
static cmat4 cmat4_set_row_v(const char *mat, const char *vec, int row) {
...
/** mat[row][:] = vec; dst = mat */
static cmat4 cmat4_set_this_row_v(char *mat, const char *vec, int row) {
...
/** dst = mat; dst[:][col] = vec */
static cmat4 cmat4_set_col_v(const char *mat, const char *vec, int col) {
...
/** mat[:][col] = vec; dst = mat */
static cmat4 cmat4_set_this_col_v(char *mat, const char *vec, int col) {
    return cmat4_set_this_col((cmat4*) mat, CVec4(vec), col);
}


/** dst = mat; dst[row][:] = scalar */
static cmat4 cmat4_set_row_sca(cmat4 mat, char scalar, int row) {
    cmatN_set_row_sca(mat.v, scalar, row, 4);
    return mat;
}
/** dst = mat; dst[row][:] = scalar */
static cmat4 cmat4_set_row_sca_v(const char *mat, char scalar, int row) {
    return cmat4_set_row_sca(CMat4(mat), scalar, row);
}

/** mat[row][:] = scalar; dst = mat */
static cmat4 cmat4_set_this_row_sca(cmat4 *mat, char scalar, int row) {
    cmatN_set_row_sca(mat->v, scalar, row, 4);
    return *mat;
}
/** mat[row][:] = scalar; dst = mat */
static cmat4 cmat4_set_this_row_sca_v(char *mat, char scalar, int row) {
    return cmat4_set_this_row_sca((cmat4*) mat, scalar, row);
}


/** dst = mat; dst[:][col] = scalar */
static cmat4 cmat4_set_col_sca(cmat4 mat, char scalar, int col) {
    cmatN_set_col_sca(mat.v, scalar, col, 4);
    return mat;
}
/** dst = mat; dst[:][col] = scalar */
static cmat4 cmat4_set_col_sca_v(const char *mat, char scalar, int col) {
    return cmat4_set_col_sca(CMat4(mat), scalar, col);
}

/** mat[:][col] = scalar; dst = mat */
static cmat4 cmat4_set_this_col_sca(cmat4 *mat, char scalar, int col) {
    cmatN_set_col_sca(mat->v, scalar, col, 4);
    return *mat;
}
/** mat[:][col] = scalar; dst = mat */
static cmat4 cmat4_set_this_col_sca_v(char *mat, char scalar, int col) {
...
/** returns sum of diagonal form upper left to lower right */
static int cmat4_trace_v(const char *mat) {
...
/** dst = mat^t */
static cmat4 cmat4_transpose_v(const char *mat) {
...
/** dst = a @ b */
static cmat4 cmat4_mul_mat_v(const char *mat_a, const char *mat_b) {
...
/** dst = a @ b */
static cvec4 cmat4_mul_vec_v(const char *mat_a, const char *vec_b) {
...
/** dst = a @ b */
static cvec4 cvec4_mul_mat_v(const char *vec_a, const char *mat_b) {
...
static int cmat4_det(cmat4 mat) {
    ...
    /* [square] det(A) = det(At) */
    char t[6];
    char a = mat.m[0][0], b = mat.m[0][1], c = mat.m[0][2], d = mat.m[0][3],
...
/** returns = determinant mat */
static int cmat4_det_v(const char *mat) {
...
static cmat4 cmat4_inv(cmat4 mat) {
    ...
    char t[6];
    char a = mat.m[0][0], b = mat.m[0][1], c = mat.m[0][2], d = mat.m[0][3];
    char e = mat.m[1][0], f = mat.m[1][1], g = mat.m[1][2], h = mat.m[1][3];
    char i = mat.m[2][0], j = mat.m[2][1], k = mat.m[2][2], l = mat.m[2][3];
    char m = mat.m[3][0], n = mat.m[3][1], o = mat.m[3][2], p = mat.m[3][3];
    ...
    char inv_det = 1.0f / (a * res.m[0][0] + b * res.m[1][0]
...
/** dst = inverted mat */
static cmat4 cmat4_inv_v(const char *mat) {
...
/** dst = mat[col:col+2, row:row+2] */
static cmat2 cmat4_get_block2_v(const char *mat, int row, int col) {
...
/** dst = mat; dst[col:col+2, row:row+2] = block */
static cmat4 cmat4_set_block2_v(const char *mat, const char *block_2, int row, int col) {
...
/** mat[col:col+2, row:row+2] = block; dst = mat */
static cmat4 cmat4_set_this_block2_v(char *mat, const char *block_2, int row, int col) {
...
/** dst = mat[col:col+2, row:row+2] */
static cmat3 cmat4_get_block3_v(const char *mat, int row, int col) {
...
/** dst = mat; dst[col:col+2, row:row+2] = block */
static cmat4 cmat4_set_block3_v(const char *mat, const char *block_3, int row, int col) {
...
/** mat[col:col+2, row:row+2] = block; dst = mat */
static cmat4 cmat4_set_this_block3_v(char *mat, const char *block_3, int row, int col) {
...
/** dst = mat[:2, :2] */
static cmat2 cmat4_get_upper_left2_v(const char *mat) {
...
/** dst = mat; dst[:2, :2] = block */
static cmat4 cmat4_set_upper_left2_v(const char *mat, const char *block_2) {
...
/** mat[:2, :2] = block; dst = mat */
static cmat4 cmat4_set_this_upper_left2_v(char *mat, const char *block_2) {
...
/** dst = mat[:3, :3] */
static cmat3 cmat4_get_upper_left3_v(const char *mat) {
...
/** dst = mat; dst[:3, :3] = block */
static cmat4 cmat4_set_upper_left3_v(const char *mat, const char *block_3) {
...
/** mat[:3, :3] = block; dst = mat */
static cmat4 cmat4_set_this_upper_left3_v(char *mat, const char *block_3) {
